...
import {
    ...
    Wrench, CalendarDays, LogOut, Menu, ArrowRightLeft, ShieldCheck
...
export default function AdminLayout() {
    ...
    const menuItems = [
        { path: '/admin/dashboard', label: 'Sistem Özeti', icon: LayoutDashboard },
        ...
        { path: '/admin/room-changes', label: 'Oda Değişimi', icon: ArrowRightLeft },
    ];
                        ...
                        <div className="relative z-10 flex items-center gap-3">
                            ...
                            >
                                ...
                                <div className="flex items-center">
                                    <span className="text-[9px] font-bold text-red-400 tracking-widest uppercase bg-red-500/10 px-1.5 py-0.5 rounded">Admin Portal</span>
                                </div>
                            </motion.div>
                        </div>
                    </div>
                    ...
                    <header className="h-20 bg-white/70 backdrop-blur-xl border-b border-slate-200/80 flex items-center justify-between px-6 lg:px-10 z-10 flex-shrink-0">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="hidden sm:flex items-center gap-2.5">
                                <ShieldCheck size={22} className="text-[#060F1E]" />
                                <h2 className="text-xl font-bold text-slate-800 tracking-tight">Yönetici Paneli</h2>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4 lg:gap-6">
                            <div className="flex items-center gap-3 cursor-pointer group">
                                <div className="text-right hidden md:block">
                                    <p className="text-sm font-bold text-slate-800 leading-tight">Admin Kullanıcısı</p>
                                    <p className="text-xs font-semibold text-slate-500 mt-0.5">Sistem Yöneticisi</p>
                                </div>
